...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("InterfaceAdaptativa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("InterfaceAdaptativa");
        ...
        config.getMapConfigs().put("com.ufes.interfaceadaptativa.domain.*", initializeDomainMapConfig(jHipsterProperties));
